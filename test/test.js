...
test( 'the `image` field corresponds to a shields.io badge url', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/coveralls/beep/boop/master.svg?style=flat', 'image url' );
	t.end();
});

test( 'the `url` field corresponds to the repository url on Coveralls', function test( t ) {
	var out = urls({
		'owner': 'beep',
		'repo': 'boop'
	});
	t.equal( out.url, 'https://coveralls.io/r/beep/boop?branch=master', 'Coveralls url' );
	t.end();
});
...
test( 'the repository branch can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/coveralls/beep/boop/develop.svg?style=flat', 'image url' );
	t.equal( out.url, 'https://coveralls.io/r/beep/boop?branch=develop', 'Coveralls url' );
	t.end();
});
...
test( 'the badge style can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/coveralls/beep/boop/master.svg?style=flat-square', 'image url' );
	t.end();
});
...
test( 'the badge format can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/coveralls/beep/boop/master.png?style=flat', 'image url' );
	t.end();
});
